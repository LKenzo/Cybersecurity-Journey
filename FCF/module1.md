...
- Educating people (Human error)
- Back up data (Plan for recovery)

Triad of InfoSec (CIA):
- Confidentiality = Private -> Disclosure = Exposed
- Integrity = Safe and unchanged -> Alteration = Tampered/changed
- Availability = Access -> Denial = Access Denied

AAA:
- Authorization = Identifying and verifying user
